<?php  
	...
	$sql = "SELECT id_alumno, nombre1, nombre2, apaterno, amaterno, tel_cel, tel_fijo, razon, correo, fecha_reg, carrera, estado_ti, estado_tra FROM alumnos as a INNER JOIN carreras as c ON a.id_carrera=c.id_carrera INNER JOIN est_ti as et on et.id_est_ti = a.id_est_ti INNER JOIN est_tra as eta ON eta.id_est_tra = a.id_est_tra WHERE a.id_carrera = 4";
