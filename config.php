        									...
        									<form id="form-pass">
        										...
        										<div class="row">
        											...
        											<div class="col-12 col-lg-8">
                                                        ...
                                                        <div class="card-body">
                                                            <h6>
                                                                Complete el campo para actualizar su contraseña
                                                            </h6>
                                                        </div>
        												<div class="mt-4">
        													<input type="password" name="passnew" placeholder="Nueva contraseña" class="form-control" id="passnew">
        												</div>
        												<div class="mt-4">
        													<div class="text-center">
        														<input type="submit" id="btn-chpass" value="Cambiar contraseña" class="btn btn-outline-success">
        													</div>
        												</div>
        											</div>
        										</div>
