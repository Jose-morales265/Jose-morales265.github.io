...
<head>
    ...
    <link rel="icon" href="img/upam.png">
			...
			<div class="col-12 col-lg-6">
				<div class="card">
					<div class="text-center">
						...
						<div class="card-body">
							<form action="validar.php" method="post"id="form-login">
								<h5 class="card-title p-2 m-2">Complete los datos para acceder</h5>
								<div class="mx-5">
									<div class="form-floating mb-4">
										<input class="form-control" id="user" name="login" type="email" placeholder="Correo">
										<label for="user">Correo</label>
									</div>
									<div class="form-floating mb-4">
										<input class="form-control" id="pass" name="password" type="password" placeholder="Contraseña">
